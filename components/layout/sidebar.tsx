...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 z-30 w-64 h-screen bg-sidebar text-sidebar-foreground border-r border-sidebar-border transition-transform duration-300 md:translate-x-0",
      ...
      >
        ...
        <div className="p-6 border-b border-sidebar-border">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-bold text-lg">SweetFlow</h1>
