...
export function InvoiceModal({ isOpen, onClose, userId, customers, products }: InvoiceModalProps) {
  ...
  const handleAddItem = () => {
    setFormData({
      ...formData,
      items: [...formData.items, { product_id: products[0]?.id || "", quantity: 1, unit_price: 0 }],
    })
  }
